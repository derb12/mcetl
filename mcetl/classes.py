# -*- coding: utf-8 -*-
"""Contains the classes for DataSource and the Functions.
...
class DataSource:
    ...
    def __init__(self, name, column_names=None, functions=None,
    ...
    def _do_functions(self, dataframes, index):
        ...
        for i, dataset in enumerate(dataframes):
            ...
            dataframes[i] = utils.optimize_memory(dataset)
